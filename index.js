...
if (!fs.existsSync(CREDS)) {
  ...
  if (!session.includes("NORA-MD~")) {
    console.log("❌ Invalid NORA-MD session format");
    process.exit(1);
  }
  ...
  console.log("♻️ NORA-MD session restored successfully");
}
...
async function connectToWA() {
  ...
  console.log(`🤖 NORA-MD Connecting with prefix: "${prefix}"`);
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log("✅ NORA-MD Bot connected to WhatsApp!");
      ...
      try {
        ...
        sock.sendMessage(ownerNumber[0] + '94743363230@s.whatsapp.net', {
          image: { url: imageUrl },
          caption: aliveMsg
        }).catch(() => {
