...
console.log(`NOVA-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+94743363230'; // Replace this with the actual owner number
        const ownerName = 'novaMd Official'; // Replace this with the owner's name
        const organization = 'NOVA CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+94743363230', '') + '+94743363230@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_NOVA-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> NOVA-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ NOVA-MD REPO: ${bot.REPO_LINK} 
┃
