...
module.exports = {
// Add Your Session Id Start With NORA-MD Hear
SESSION_ID: process.env.SESSION_ID || "",
// NORA MD Api Site Url
API_BASE: process.env.API_BASE || "https://arslan-apis.vercel.app/",
// NORA MD Api Key -- Add This To Your Api Key Form Api Site
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY NORA-MD 🤍*",
...
BOT_NAME: process.env.BOT_NAME || "NORA-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "NORA-MD",
...
OWNER_NAME: process.env.OWNER_NAME || "NOVAofc Official",
